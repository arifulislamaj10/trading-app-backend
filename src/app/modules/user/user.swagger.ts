export const userSwaggerDocs = {
  "/api/v1/user/update-profile": {
    patch: {
            ...
            schema: {
              ...
              properties: {
                ...
                userProfileUrl: {
                  ...
                  format: "uri",
                  description:
                    "URL of the profile image. Obtain this by first uploading an image to POST /api/v1/upload/file.",
                  example:
                    "https://your-bucket.s3.your-region.amazonaws.com/uploads/profile_abc123.jpg",
                },
                referralCode: {
                  type: "string",
                  description:
                    "Unique referral code (3-20 chars, uppercase alphanumeric and underscores). Note: Can only be changed ONCE.",
      ...
      responses: {
        ...
        401: {
          description:
            "Unauthorized — must be logged in as ADMIN, USER, or MASTER",
        },
      },
    },
  },
  ...
  "/api/v1/user/{id}": {
    ...
    patch: {
      ...
      description:
        "Update a user's account status (ACTIVE or SUSPENDED). Requires ADMIN role.",
      security: [{ bearerAuth: [] }],
      parameters: [
        {
          name: "id",
    ...
    delete: {
      ...
      summary: "Delete user",
      description:
        'Soft delete a user by ID. This operation marks the user as deleted rather than permanently removing them. Requires ADMIN role. Request body must include confirmation: "DELETE".',
      security: [{ bearerAuth: [] }],
      parameters: [
        {
          name: "id",
            ...
            schema: {
              ...
              properties: {
                confirmation: {
                  ...
                  example: "DELETE",
                  description:
                    "Must be the exact string DELETE to confirm deletion",
                },
              },
            },
          },

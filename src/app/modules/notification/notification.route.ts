...
notificationRouter.get(
  "/unread-count",
  notification_controllers.get_unread_count,
);

// GET /stream - Near real-time SSE notification delivery
notificationRouter.get(
  "/stream",
  notification_controllers.stream_notifications,
);

// PATCH /read-all - Mark all unread notifications as read
notificationRouter.patch(
  "/read-all",
  notification_controllers.mark_all_as_read,
);
...
notificationRouter.patch(
  "/:id/read",
  notification_controllers.mark_single_as_read,
);
